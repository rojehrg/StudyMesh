      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Attunly is a team collaboration platform that enables:
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              To use Attunly, you must create an account. When creating your account, you agree to:
            </p>
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">You agree NOT to use Attunly to:</p>
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              You retain ownership of content you submit to Attunly (&quot;User Content&quot;), including your profile information, skills, availability, and messages. By submitting User Content, you grant us a worldwide, non-exclusive, royalty-free license to use, store, display, and distribute your content solely for the purpose of providing the Services.
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              When you create or join an organization on Attunly:
            </p>
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Attunly integrates with third-party services such as Slack. When you connect these services:
            </p>
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              You may stop using Attunly at any time by deleting your account. We reserve the right to suspend or terminate your access to the Services at any time, with or without cause or notice, including for:
            </p>
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, ATTUNLY SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO:
            </p>
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600">
              You agree to indemnify, defend, and hold harmless Attunly and its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from your use of the Services, your User Content, or your violation of these Terms.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              <li><strong>Entire Agreement:</strong> These Terms constitute the entire agreement between you and Attunly regarding the Services.</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-none text-gray-600 space-y-2">
              <li><strong>Email:</strong> legal@attunly.app</li>

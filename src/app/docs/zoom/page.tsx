        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Connect Zoom to automatically create meeting links</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <Card className="bg-violet-50 border-violet-200">
              <CardContent className="pt-4">
                <h3 className="font-medium text-gray-900 mb-2">What data does Attunly access?</h3>
            ...
            <Card className="bg-white border-gray-200">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-gray-900">Connecting Zoom</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-violet-600 rounded-full flex items-center justify-center text-white text-sm font-medium shrink-0">1</div>
                  <div>
                    <p className="font-medium text-gray-900">Go to Settings</p>
                    <p className="text-sm text-gray-600">Click on Settings in the sidebar, then select the "Integrations" tab.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-violet-600 rounded-full flex items-center justify-center text-white text-sm font-medium shrink-0">2</div>
                  <div>
                    <p className="font-medium text-gray-900">Click "Connect Zoom"</p>
                    <p className="text-sm text-gray-600">Find the Zoom section and click the Connect button.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-violet-600 rounded-full flex items-center justify-center text-white text-sm font-medium shrink-0">3</div>
                  <div>
                    <p className="font-medium text-gray-900">Authorize with Zoom</p>
                    <p className="text-sm text-gray-600">You'll be redirected to Zoom. Sign in and click "Allow" to grant Attunly access.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">You'll be redirected back to Attunly. Zoom is now connected.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border-gray-200">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-gray-900">Using the Integration</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
            ...
            <Card className="bg-white border-gray-200">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-gray-900">Disconnecting Zoom</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-gray-600">
                ...
                <ol className="space-y-2 text-gray-600 list-decimal list-inside">
                  ...
                  <li>Optionally, revoke access from your <a href="https://marketplace.zoom.us/user/installed" className="text-violet-600 hover:underline" target="_blank" rel="noopener noreferrer">Zoom Marketplace installed apps</a></li>
                </ol>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-medium text-gray-900 mb-1">Connection failed?</h3>
                <p className="text-sm text-gray-600">
                  Make sure you're signed into the correct Zoom account. Try disconnecting and reconnecting.
                </p>
              </div>
              <div>
                <h3 className="font-medium text-gray-900 mb-1">Meeting links not generating?</h3>
                <p className="text-sm text-gray-600">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Contact us at <a href="mailto:support@attunly.com" className="text-violet-600 hover:underline">support@attunly.com</a>
                </p>
              </div>
            </div>
          </section>

          ...
          <main className="flex-1 flex items-center justify-center px-6 md:px-12 lg:px-16">
            <div className="w-full max-w-sm text-center">
              ...
              <p className="mt-4 text-coffee-cortado">
                We sent a confirmation link to <span className="font-medium text-coffee-espresso">{email}</span>
              </p>
              <p className="mt-2 text-coffee-latte text-sm">Click the link in your email to activate your account.</p>
              <Link
                href="/login"
        ...
        <main className="flex-1 flex items-center justify-center px-6 md:px-12 lg:px-16">
          <div className="w-full max-w-sm">
            ...
            <p className="mt-2 text-coffee-cortado">
              Describe what you know. Help your team find you.
            </p>
            ...
            <button
              ...
              disabled={loading}
              className="mt-8 w-full h-11 rounded-lg border border-coffee-foam bg-white text-coffee-mocha font-medium hover:bg-coffee-cream focus:outline-none focus:ring-2 focus:ring-coffee-foam disabled:opacity-50 flex items-center justify-center gap-3 transition-colors"
            >
            ...
            <form onSubmit={handleEmailSignup} className="mt-6 space-y-5">
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-coffee-mocha mb-1.5">
                  Password
                </label>
                <input
                  id="password"
            ...
            <p className="mt-4 text-xs text-coffee-latte text-center">
              By creating an account, you agree to our{" "}
              <Link href="/terms" className="underline hover:text-coffee-cortado">Terms</Link> and{" "}
              <Link href="/privacy" className="underline hover:text-coffee-cortado">Privacy Policy</Link>.
            </p>
          </div>
        </main>
      </div>

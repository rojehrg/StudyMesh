...
// Context to share description ID for aria-describedby
const DialogDescriptionContext = React.createContext<string | undefined>(undefined)
...
>(({ className, id, ...props }, ref) => {
  // Use the context ID if no explicit ID is provided
  const contextId = React.useContext(DialogDescriptionContext)
  const descriptionId = id || contextId

    ...
    return rx.el.div(
        rx.el.div(
            rx.el.div(
                ...
                rx.el.p(
                    "Find your perfect study group match.",
    ...
    return rx.el.form(
        ...
        rx.el.button(
            rx.cond(
                ...
                rx.el.span("Signing in...", class_name="flex items-center gap-2"),
                "Sign In",
            ),
            type="submit",
...
def signup_form() -> rx.Component:
    return rx.el.form(
        ...
        rx.el.button(
            rx.cond(
                AuthState.is_authenticating,
                rx.el.span("Creating Account...", class_name="flex items-center gap-2"),
                "Create Account",
            ),
            type="submit",
            disabled=AuthState.is_authenticating,

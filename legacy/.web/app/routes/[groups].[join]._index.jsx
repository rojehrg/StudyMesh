...
function Input_3c62168952f2eb72865eac401d5d1304 () {
...
const on_change_881e17e0177e8d578fe4430b60974976 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___micro_group_state____micro_group_state.set_join_group_code", ({ ["value"] : _e?.["target"]?.["value"] }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("input",{className:"w-full px-4 py-3 border border-gray-300 rounded-lg text-left text-2xl tracking-widest font-mono uppercase mb-6 placeholder:text-gray-500 focus:border-[#4F46E5] focus:ring-1 focus:ring-[#4F46E5] outline-none focus:placeholder-transparent",defaultValue:reflex___state____state__app___states___micro_group_state____micro_group_state.join_group_code_rx_state_,maxLength:6,onChange:on_change_881e17e0177e8d578fe4430b60974976,placeholder:"e.g. AB12CD"},)
  )
}


function Button_fc04cfcf4c6dfb4084224de160eba5a4 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_click_52804f680d6de6c4f09905e4dd3a3491 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___micro_group_state____micro_group_state.join_group", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("button",{className:"w-full bg-indigo-600 text-white py-3 rounded-xl font-bold hover:bg-indigo-700 transition-colors shadow-md",onClick:on_click_52804f680d6de6c4f09905e4dd3a3491},"Join Circle")
  )
}

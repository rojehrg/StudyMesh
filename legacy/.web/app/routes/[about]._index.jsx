...
import {Bell as LucideBell,BookOpen as LucideBookOpen,ChevronLeft as LucideChevronLeft,CirclePlus as LucideCirclePlus,Info as LucideInfo,LayoutDashboard as LucideLayoutDashboard,LogIn as LucideLogIn,LogOut as LucideLogOut,Menu as LucideMenu,Settings as LucideSettings,Target as LucideTarget,Users as LucideUsers,Zap as LucideZap} from "lucide-react"
...
export default function Component() {
  ...
  return (
    jsx(Fragment,{},jsx("div",{className:"flex w-full min-h-screen bg-gray-50"},jsx("div",{},jsx(Div_c1f3c749b807c06ffcf591c756121421,{},),jsx(Aside_06c0acd7e6bdf09e1f3254efc9bcd432,{},)),jsx(Aside_1ef380eabec6f8bf6ae3f4d1a32f6e09,{},),jsx("div",{className:"flex-1 flex flex-col min-w-0"},jsx("header",{className:"md:hidden flex items-center px-4 h-16 bg-white border-b border-gray-200 sticky top-0 z-30"},jsx(Button_0d8d7a023769a6649a4c5923bdbd66e6,{},),jsx(ReactRouterLink,{className:"text-lg font-bold text-indigo-600 hover:opacity-80 transition-opacity",to:"/landing"},"Meshflow")),jsx("main",{className:"flex-1 bg-gray-50 min-h-[calc(100vh-4rem)] md:min-h-screen overflow-auto transition-all duration-300"},jsx("div",{className:"min-h-screen font-['Inter']"},jsx("div",{className:"bg-white border-b border-gray-100 px-6 py-16 md:py-24"},jsx("div",{className:"max-w-4xl"},jsx("span",{className:"text-xs font-bold tracking-wider text-indigo-600 mb-4 block"},"KNOWLEDGE IN MOTION"),jsx("h1",{className:"text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight"},"Enablement that actually flows"),jsx("p",{className:"text-lg text-gray-600 mb-8 max-w-2xl leading-relaxed"},"Meshflow pairs employees who have specific expertise with teammates who need it, automatically organizing them into focused, high-impact working circles."))),jsx("div",{className:"bg-gray-50/50"},jsx("div",{className:"max-w-7xl mx-auto px-6 py-16"},jsx("h2",{className:"text-2xl font-bold text-gray-900 mb-8"},"Why Meshflow?"),jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-6"},jsx("div",{className:"bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300"},jsx("div",{className:"w-12 h-12 bg-amber-50 rounded-xl flex items-center justify-center mb-4"},jsx(LucideZap,{className:"w-6 h-6 text-amber-600"},)),jsx("h3",{className:"text-lg font-bold text-gray-900 mb-2"},"Close Gaps Faster"),jsx("p",{className:"text-gray-600 text-sm leading-relaxed"},"Stop waiting for formal training cycles. Connect directly with peers who have the answers you need right now.")),jsx("div",{className:"bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300"},jsx("div",{className:"w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center mb-4"},jsx(LucideUsers,{className:"w-6 h-6 text-blue-600"},)),jsx("h3",{className:"text-lg font-bold text-gray-900 mb-2"},"Break Silos"),jsx("p",{className:"text-gray-600 text-sm leading-relaxed"},"Our algorithm connects people across departments and seniority levels based on shared goals and complementary skills.")),jsx("div",{className:"bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300"},jsx("div",{className:"w-12 h-12 bg-green-50 rounded-xl flex items-center justify-center mb-4"},jsx(LucideTarget,{className:"w-6 h-6 text-green-600"},)),jsx("h3",{className:"text-lg font-bold text-gray-900 mb-2"},"Outcome Driven"),jsx("p",{className:"text-gray-600 text-sm leading-relaxed"},"Every connection is tied to a specific business outcome or KPI, ensuring learning translates to results."))))),jsx("div",{className:"bg-white border-y border-gray-100"},jsx("div",{className:"max-w-7xl mx-auto px-6 py-16"},jsx("h2",{className:"text-2xl font-bold text-gray-900 mb-12 text-center"},"How it Works"),jsx("div",{className:"relative max-w-6xl mx-auto"},jsx("div",{className:"hidden md:block absolute top-8 left-0 w-full h-0.5 bg-indigo-100 -z-0"},),jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative"},jsx("div",{className:"relative z-10"},jsx("div",{className:"w-8 h-8 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center mb-4"},jsx("span",{className:"text-sm font-bold text-indigo-600"},"1")),jsx("h3",{className:"text-lg font-bold text-gray-900 mb-2"},"Create Profile"),jsx("p",{className:"text-gray-600 text-sm leading-relaxed"},"Share your expertise, growth goals, and availability. Be honest about your reliability score.")),jsx("div",{className:"relative z-10"},jsx("div",{className:"w-8 h-8 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center mb-4"},jsx("span",{className:"text-sm font-bold text-indigo-600"},"2")),jsx("h3",{className:"text-lg font-bold text-gray-900 mb-2"},"Join a Pod"),jsx("p",{className:"text-gray-600 text-sm leading-relaxed"},"Enter a pod code to join a group focused on a specific business outcome (e.g., 'Q4 Product Launch').")),jsx("div",{className:"relative z-10"},jsx("div",{className:"w-8 h-8 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center mb-4"},jsx("span",{className:"text-sm font-bold text-indigo-600"},"3")),jsx("h3",{className:"text-lg font-bold text-gray-900 mb-2"},"Get Matched"),jsx("p",{className:"text-gray-600 text-sm leading-relaxed"},"Our algorithm analyzes compatibility scores (skills, goals, logistics) to find your perfect working circle.")),jsx("div",{className:"relative z-10"},jsx("div",{className:"w-8 h-8 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center mb-4"},jsx("span",{className:"text-sm font-bold text-indigo-600"},"4")),jsx("h3",{className:"text-lg font-bold text-gray-900 mb-2"},"Collaborate"),jsx("p",{className:"text-gray-600 text-sm leading-relaxed"},"Meet with your circle (sync or async) to exchange knowledge and drive the pod's outcome forward.")))))),jsx("div",{className:"bg-gray-50"},jsx("div",{className:"max-w-7xl mx-auto px-6 py-16 text-center"},jsx("div",{className:"max-w-4xl mx-auto"},jsx("h2",{className:"text-2xl font-bold text-gray-900 mb-4"},"The Matching Engine"),jsx("p",{className:"text-gray-600 mb-8 max-w-2xl"},"We don't just match based on titles. We calculate a 100-point compatibility score for every potential pair."),jsx("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4"},jsx("div",{className:"p-4 bg-white rounded-lg border border-gray-200"},jsx("span",{className:"text-sm font-bold text-gray-500 uppercase tracking-wider mb-2 block"},"30%"),jsx("p",{className:"font-medium text-gray-900"},"Skill Alignment")),jsx("div",{className:"p-4 bg-white rounded-lg border border-gray-200"},jsx("span",{className:"text-sm font-bold text-gray-500 uppercase tracking-wider mb-2 block"},"20%"),jsx("p",{className:"font-medium text-gray-900"},"Goal Similarity")),jsx("div",{className:"p-4 bg-white rounded-lg border border-gray-200"},jsx("span",{className:"text-sm font-bold text-gray-500 uppercase tracking-wider mb-2 block"},"35%"),jsx("p",{className:"font-medium text-gray-900"},"Logistics (Time/Loc)")),jsx("div",{className:"p-4 bg-white rounded-lg border border-gray-200"},jsx("span",{className:"text-sm font-bold text-gray-500 uppercase tracking-wider mb-2 block"},"15%"),jsx("p",{className:"font-medium text-gray-900"},"Reliability Score"))))))))),jsx(Button_5c3b3b0b916bef960265a28869919bde,{},)),jsx("title",{},"App | About"),jsx("meta",{content:"favicon.ico",property:"og:image"},))
  )
}
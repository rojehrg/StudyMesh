...
import {Checkbox as RadixThemesCheckbox,Flex as RadixThemesFlex,Text as RadixThemesText} from "@radix-ui/themes"
...
function Input_d11b7a7d3faef213ce39a41dad64ddef () {
...
const on_change_1a2129d9b0d82ae851ca1d67f468da17 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___micro_group_state____micro_group_state.set_new_group_name", ({ ["value"] : _e?.["target"]?.["value"] }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("input",{className:"w-full px-4 py-2 border border-gray-300 rounded-lg",defaultValue:reflex___state____state__app___states___micro_group_state____micro_group_state.new_group_name_rx_state_,onChange:on_change_1a2129d9b0d82ae851ca1d67f468da17,placeholder:"e.g. Platform Rollout SWAT"},)
  )
}


function Textarea_31f065f51057e4b327f8666c5fc24ab0 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_change_40f0551af640f82c977f665cc8ce24b5 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___micro_group_state____micro_group_state.set_new_group_description", ({ ["value"] : _e?.["target"]?.["value"] }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("textarea",{className:"w-full px-4 py-2 border border-gray-300 rounded-lg resize-none h-24",onChange:on_change_40f0551af640f82c977f665cc8ce24b5,placeholder:"What business objective or enablement outcome is this circle driving?"},)
  )
}


function Fragment_ad2c7475031ec3dcd0ea1e16feaa023e () {
  const reflex___state____state__app___states___micro_group_state____micro_group_state = useContext(StateContexts.reflex___state____state__app___states___micro_group_state____micro_group_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);
  ...
  return (
    jsx(Fragment,{},Array.prototype.map.call(reflex___state____state__app___states___micro_group_state____micro_group_state.available_classmates_rx_state_ ?? [],((user_rx_state_,index_4b6dc46ccad4a3f78743b9aaf52831fc)=>(jsx("div",{className:"flex items-center p-2 hover:bg-gray-50 rounded-lg border border-transparent hover:border-gray-200 transition-colors",key:index_4b6dc46ccad4a3f78743b9aaf52831fc},jsx(RadixThemesText,{as:"label",size:"2"},jsx(RadixThemesFlex,{gap:"2"},jsx(RadixThemesCheckbox,{checked:reflex___state____state__app___states___micro_group_state____micro_group_state.selected_classmate_ids_rx_state_.includes(user_rx_state_?.["id"]),onCheckedChange:((_ev_0) => (addEvents([(ReflexEvent("reflex___state____state.app___states___micro_group_state____micro_group_state.toggle_classmate_selection", ({ ["user_id"] : user_rx_state_?.["id"] }), ({  })))], [_ev_0], ({  })))),size:"2"},),"")),jsx("span",{className:"ml-2 text-gray-700"},user_rx_state_?.["name"]))))))
  )
}


function Fragment_cb1ee481dbf135effdc4d432e86d9df9 () {
  const reflex___state____state__app___states___micro_group_state____micro_group_state = useContext(StateContexts.reflex___state____state__app___states___micro_group_state____micro_group_state)



  return (
    jsx(Fragment,{},(isTrue(reflex___state____state__app___states___micro_group_state____micro_group_state.available_classmates_rx_state_)?(jsx(Fragment_ad2c7475031ec3dcd0ea1e16feaa023e,{},)):(jsx(Fragment,{},jsx("p",{className:"text-gray-500 italic text-sm"},"No eligible teammates found.")))))
  )
}


function Button_bad3d40a537d1a0899d72171ca81f3fc () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_click_f5e8aabd80957c2957502188cd1bac3f = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___micro_group_state____micro_group_state.create_group", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("button",{className:"w-full bg-indigo-600 text-white py-3 rounded-xl font-bold hover:bg-indigo-700 transition-colors shadow-md",onClick:on_click_f5e8aabd80957c2957502188cd1bac3f},"Create Circle")
  )
}
...
export default function Component() {
  ...
  return (
    jsx(Fragment,{},jsx("div",{className:"flex w-full min-h-screen bg-gray-50"},jsx("div",{},jsx(Div_c1f3c749b807c06ffcf591c756121421,{},),jsx(Aside_06c0acd7e6bdf09e1f3254efc9bcd432,{},)),jsx(Aside_1ef380eabec6f8bf6ae3f4d1a32f6e09,{},),jsx("div",{className:"flex-1 flex flex-col min-w-0"},jsx("header",{className:"md:hidden flex items-center px-4 h-16 bg-white border-b border-gray-200 sticky top-0 z-30"},jsx(Button_0d8d7a023769a6649a4c5923bdbd66e6,{},),jsx(ReactRouterLink,{className:"text-lg font-bold text-indigo-600 hover:opacity-80 transition-opacity",to:"/landing"},"Meshflow")),jsx("main",{className:"flex-1 bg-gray-50 min-h-[calc(100vh-4rem)] md:min-h-screen overflow-auto transition-all duration-300"},jsx("div",{className:"p-8 flex items-center justify-center min-h-[80vh]"},jsx("div",{},jsx("h2",{className:"text-2xl font-bold text-gray-900 mb-6"},"Create a Working Circle"),jsx("div",{className:"bg-white p-8 rounded-xl border border-gray-200 shadow-sm max-w-lg mx-auto"},jsx("div",{className:"mb-4"},jsx("label",{className:"block text-sm font-medium text-gray-700 mb-1"},"Circle Name"),jsx(Input_d11b7a7d3faef213ce39a41dad64ddef,{},)),jsx("div",{className:"mb-4"},jsx("label",{className:"block text-sm font-medium text-gray-700 mb-1"},"Description (Optional)"),jsx(Textarea_31f065f51057e4b327f8666c5fc24ab0,{},)),jsx("div",{className:"mb-6"},jsx("label",{className:"block text-sm font-medium text-gray-700 mb-2"},"Select collaborators (max 4)"),jsx("div",{className:"border border-gray-200 rounded-lg p-3 max-h-48 overflow-y-auto bg-gray-50"},jsx(Fragment_cb1ee481dbf135effdc4d432e86d9df9,{},))),jsx(Button_bad3d40a537d1a0899d72171ca81f3fc,{},)))))),jsx(Button_5c3b3b0b916bef960265a28869919bde,{},)),jsx("title",{},"App | Create"),jsx("meta",{content:"favicon.ico",property:"og:image"},))
  )
}
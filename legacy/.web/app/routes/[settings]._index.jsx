...
import {Bell as LucideBell,BookOpen as LucideBookOpen,ChevronLeft as LucideChevronLeft,CircleHelp as LucideCircleHelp,CirclePlus as LucideCirclePlus,Info as LucideInfo,LayoutDashboard as LucideLayoutDashboard,LogIn as LucideLogIn,LogOut as LucideLogOut,Mail as LucideMail,Menu as LucideMenu,Settings as LucideSettings,Trash2 as LucideTrash2,Users as LucideUsers,X as LucideX} from "lucide-react"
import {Checkbox as RadixThemesCheckbox,Flex as RadixThemesFlex,Select as RadixThemesSelect,Switch as RadixThemesSwitch,Tabs as RadixThemesTabs,Text as RadixThemesText} from "@radix-ui/themes"
...
function Form_c669a5ae73d3664f5f8f4e0b951441af () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);

    const handleSubmit_6c4255bde9e4709b2dc9065ed8a25f2a = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({  })};

        (((...args) => (addEvents([(ReflexEvent("reflex___state____state.app___states___auth_state____auth_state.change_password", ({ ["form_data"] : form_data }), ({  })))], args, ({  }))))(ev));
  ...
  return (
    jsx("form",{className:"bg-white p-6 rounded-xl border border-gray-200 shadow-sm max-w-md",onSubmit:handleSubmit_6c4255bde9e4709b2dc9065ed8a25f2a},jsx("div",{},jsx("label",{className:"block text-sm font-medium text-gray-700 mb-1"},"Current Password"),jsx("input",{className:"w-full px-3 py-2 border border-gray-300 rounded-lg mb-4 focus:border-[#4F46E5] focus:ring-1 focus:ring-[#4F46E5] outline-none",name:"current_password",type:"password"},)),jsx("div",{},jsx("label",{className:"block text-sm font-medium text-gray-700 mb-1"},"New Password"),jsx("input",{className:"w-full px-3 py-2 border border-gray-300 rounded-lg mb-4 focus:border-[#4F46E5] focus:ring-1 focus:ring-[#4F46E5] outline-none",name:"new_password",type:"password"},)),jsx("div",{},jsx("label",{className:"block text-sm font-medium text-gray-700 mb-1"},"Confirm New Password"),jsx("input",{className:"w-full px-3 py-2 border border-gray-300 rounded-lg mb-6 focus:border-[#4F46E5] focus:ring-1 focus:ring-[#4F46E5] outline-none",name:"confirm_new_password",type:"password"},)),jsx("button",{className:"bg-indigo-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-indigo-700",type:"submit"},"Update Password"))
  )
}


function P_f80e2a00a33e53ee4dacacbd38d70f31 () {
  const reflex___state____state__app___states___auth_state____auth_state = useContext(StateContexts.reflex___state____state__app___states___auth_state____auth_state)



  return (
    jsx("p",{className:"font-semibold text-gray-900"},reflex___state____state__app___states___auth_state____auth_state.user_email_rx_state_)
  )
}


function Button_3ca1ddc6a90a1f4baf94601fcf9cc43e () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_click_89aa8e83d182afda1880a23ecebf2ac4 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___auth_state____auth_state.sign_in_with_google", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("button",{className:"bg-indigo-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-indigo-700",onClick:on_click_89aa8e83d182afda1880a23ecebf2ac4},"Connect Google Account")
  )
}


function Fragment_7f79c60875f3f9e9ef2865e1eb15b3d4 () {
  const reflex___state____state__app___states___auth_state____auth_state = useContext(StateContexts.reflex___state____state__app___states___auth_state____auth_state)



  return (
    jsx(Fragment,{},((reflex___state____state__app___states___auth_state____auth_state.oauth_provider_rx_state_?.valueOf?.() === "google"?.valueOf?.())?(jsx(Fragment,{},jsx("div",{className:"max-w-2xl"},jsx("div",{},jsx("div",{className:"flex items-center p-4 bg-white rounded-xl border border-gray-200 mb-4"},jsx("div",{className:"w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center mr-4"},jsx(LucideMail,{className:"w-5 h-5 text-indigo-600"},)),jsx("div",{className:"flex-1"},jsx(P_f80e2a00a33e53ee4dacacbd38d70f31,{},),jsx("p",{className:"text-sm text-gray-500"},"Connected with Google")),jsx("div",{className:"flex items-center"},jsx("span",{className:"px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium"},"Connected"))),jsx("div",{className:"bg-gray-50 p-6 rounded-xl border border-gray-200"},jsx("p",{className:"text-sm text-gray-600 mb-4"},"Your Google account is connected. You can sign in with Google."),jsx("button",{className:"bg-white text-red-600 border border-red-200 px-4 py-2 rounded-lg font-medium hover:bg-red-50"},"Unlink Google Account")))))):(jsx(Fragment,{},jsx("div",{className:"max-w-2xl"},jsx("div",{className:"flex items-center p-4 bg-white rounded-xl border border-gray-200"},jsx("div",{className:"w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center mr-4"},jsx(LucideMail,{className:"w-5 h-5 text-gray-400"},)),jsx("div",{className:"flex-1"},jsx("p",{className:"font-semibold text-gray-900"},"No Google account connected"),jsx("p",{className:"text-sm text-gray-500"},"Connect your Google account to sign in faster and sync your profile.")),jsx(Button_3ca1ddc6a90a1f4baf94601fcf9cc43e,{},)))))))
  )
}


function Button_60a5b3f49d33909c7575bb90ba165da5 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_click_c14ece8e2e1f1fe01f3aa4b99ee4e6ac = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___auth_state____auth_state.delete_account", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("button",{className:"w-full bg-red-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-red-700 transition-all shadow-lg hover:shadow-xl flex items-center justify-center",onClick:on_click_c14ece8e2e1f1fe01f3aa4b99ee4e6ac},jsx(LucideTrash2,{className:"w-5 h-5 mr-2"},),"Delete My Account Permanently")
  )
}
...
export default function Component() {
  ...
  return (
    jsx(Fragment,{},jsx("div",{className:"flex w-full min-h-screen bg-gray-50"},jsx("div",{},jsx(Div_c1f3c749b807c06ffcf591c756121421,{},),jsx(Aside_06c0acd7e6bdf09e1f3254efc9bcd432,{},)),jsx(Aside_1ef380eabec6f8bf6ae3f4d1a32f6e09,{},),jsx("div",{className:"flex-1 flex flex-col min-w-0"},jsx("header",{className:"md:hidden flex items-center px-4 h-16 bg-white border-b border-gray-200 sticky top-0 z-30"},jsx(Button_0d8d7a023769a6649a4c5923bdbd66e6,{},),jsx(ReactRouterLink,{className:"text-lg font-bold text-indigo-600 hover:opacity-80 transition-opacity",to:"/landing"},"Meshflow")),jsx("main",{className:"flex-1 bg-gray-50 min-h-[calc(100vh-4rem)] md:min-h-screen overflow-auto transition-all duration-300"},jsx("div",{className:"p-4 md:p-8"},jsx("h1",{className:"text-2xl font-bold text-gray-900 mb-6"},"Settings"),jsx(RadixThemesTabs.Root,{css:({ ["&[data-orientation='vertical']"] : ({ ["display"] : "flex" }) }),defaultValue:"profile"},jsx(RadixThemesTabs.List,{className:"flex gap-4 border-b border-gray-200 mb-8",css:({ ["&[data-orientation='vertical']"] : ({ ["display"] : "block", ["boxShadow"] : "inset -1px 0 0 0 var(--gray-a5)" }) })},jsx(RadixThemesTabs.Trigger,{className:"px-4 py-2 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:text-gray-700 data-[state=active]:text-indigo-600 data-[state=active]:border-indigo-600 transition-all",css:({ ["&[data-orientation='vertical']"] : ({ ["width"] : "100%" }) }),value:"profile"},"Edit Profile"),jsx(RadixThemesTabs.Trigger,{className:"px-4 py-2 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:text-gray-700 data-[state=active]:text-indigo-600 data-[state=active]:border-indigo-600 transition-all",css:({ ["&[data-orientation='vertical']"] : ({ ["width"] : "100%" }) }),value:"password"},"Password"),jsx(RadixThemesTabs.Trigger,{className:"px-4 py-2 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:text-gray-700 data-[state=active]:text-indigo-600 data-[state=active]:border-indigo-600 transition-all",css:({ ["&[data-orientation='vertical']"] : ({ ["width"] : "100%" }) }),value:"google"},"Google Account"),jsx(RadixThemesTabs.Trigger,{className:"px-4 py-2 text-sm font-medium text-gray-500 border-b-2 border-transparent hover:text-gray-700 data-[state=active]:text-indigo-600 data-[state=active]:border-indigo-600 transition-all",css:({ ["&[data-orientation='vertical']"] : ({ ["width"] : "100%" }) }),value:"account"},"Account")),jsx(RadixThemesTabs.Content,{css:({ ["&[data-orientation='vertical']"] : ({ ["width"] : "100%", ["margin"] : null }) }),value:"profile"},jsx("div",{className:"max-w-3xl"},jsx(Div_5e216a5a5469e9b393ad986d72668053,{},))),jsx(RadixThemesTabs.Content,{css:({ ["&[data-orientation='vertical']"] : ({ ["width"] : "100%", ["margin"] : null }) }),value:"password"},jsx("div",{},jsx("h3",{className:"text-lg font-semibold text-gray-900 mb-4"},"Change Password"),jsx(Form_c669a5ae73d3664f5f8f4e0b951441af,{},))),jsx(RadixThemesTabs.Content,{css:({ ["&[data-orientation='vertical']"] : ({ ["width"] : "100%", ["margin"] : null }) }),value:"google"},jsx("div",{},jsx("h3",{className:"text-lg font-semibold text-gray-900 mb-4"},"Google Account"),jsx(Fragment_7f79c60875f3f9e9ef2865e1eb15b3d4,{},))),jsx(RadixThemesTabs.Content,{css:({ ["&[data-orientation='vertical']"] : ({ ["width"] : "100%", ["margin"] : null }) }),value:"account"},jsx("div",{},jsx("div",{className:"max-w-2xl"},jsx("div",{className:"mb-6"},jsx(LucideCircleHelp,{className:"w-6 h-6 text-red-500 mb-3"},),jsx("h3",{className:"text-xl font-bold text-red-600 mb-2"},"Danger Zone"),jsx("p",{className:"text-gray-600 text-sm leading-relaxed"},"Permanently delete your account and all associated data. This action cannot be undone.")),jsx("div",{className:"max-w-lg"},jsx("div",{className:"bg-white p-5 rounded-xl border border-gray-200 mb-6"},jsx("div",{},jsx("p",{className:"font-semibold text-gray-900 mb-2"},"\u26a0\ufe0f What will be deleted:"),jsx("ul",{className:"list-disc list-inside space-y-1 mb-6"},jsx("li",{className:"text-sm text-gray-600 mb-1"},"Your profile and preferences"),jsx("li",{className:"text-sm text-gray-600 mb-1"},"All pod memberships and working circles"),jsx("li",{className:"text-sm text-gray-600 mb-1"},"Session logs and enablement history"),jsx("li",{className:"text-sm text-gray-600"},"All compatibility scores and matches")))),jsx(Button_60a5b3f49d33909c7575bb90ba165da5,{},))))))))),jsx(Button_5c3b3b0b916bef960265a28869919bde,{},)),jsx("title",{},"App | Settings"),jsx("meta",{content:"favicon.ico",property:"og:image"},))
  )
}
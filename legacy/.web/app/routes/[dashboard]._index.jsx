...
import {Bell as LucideBell,BookOpen as LucideBookOpen,ChevronLeft as LucideChevronLeft,CirclePlus as LucideCirclePlus,Info as LucideInfo,LayoutDashboard as LucideLayoutDashboard,LogIn as LucideLogIn,LogOut as LucideLogOut,Menu as LucideMenu,Settings as LucideSettings,User as LucideUser,Users as LucideUsers} from "lucide-react"
...
function Div_541e8302854bf4c117d520de44e0243f () {
  ...
  return (
    jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"},Array.prototype.map.call(reflex___state____state__app___states___class_state____class_state.user_classes_rx_state_ ?? [],((class_obj_rx_state_,index_bffa2359493f7d736a7d6fc451f7bca4)=>(jsx(ReactRouterLink,{className:"block",key:index_bffa2359493f7d736a7d6fc451f7bca4,to:("/classes/"+class_obj_rx_state_?.["id"])},jsx("div",{className:"bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow h-full flex flex-col"},jsx("div",{className:"flex justify-between items-start mb-2"},jsx("h3",{className:"text-lg font-bold text-gray-900"},class_obj_rx_state_?.["class_name"]),jsx("span",{className:"text-xs font-mono bg-indigo-100 text-indigo-700 px-2 py-1 rounded-md"},class_obj_rx_state_?.["class_code"])),jsx("p",{className:"text-sm text-gray-500 mb-1"},("Business Unit: "+class_obj_rx_state_?.["school"])),jsx("div",{className:"flex items-center mb-4"},jsx(LucideUser,{className:"w-4 h-4 text-gray-400 mr-2"},),jsx("span",{className:"text-sm text-gray-600"},("Owner: "+class_obj_rx_state_?.["professor"]))),jsx("div",{className:"flex justify-between items-center mt-auto pt-4 border-t border-gray-100"},jsx("span",{className:"text-xs text-gray-500 font-medium"},("Timeline: "+class_obj_rx_state_?.["term"])),jsx("span",{className:"text-sm font-semibold text-indigo-600 hover:text-indigo-800"},"View Pod \u2192"))))))))
  )
}


function Fragment_22a41101ff4841fb23790892a7cfad56 () {
  const reflex___state____state__app___states___class_state____class_state = useContext(StateContexts.reflex___state____state__app___states___class_state____class_state)



  return (
    jsx(Fragment,{},(isTrue(reflex___state____state__app___states___class_state____class_state.user_classes_rx_state_)?(jsx(Fragment,{},jsx(Div_541e8302854bf4c117d520de44e0243f,{},))):(jsx(Fragment,{},jsx("div",{className:"flex flex-col items-center justify-center py-20 bg-white rounded-xl border border-dashed border-gray-300"},jsx(LucideUsers,{className:"w-16 h-16 text-gray-300 mb-4"},),jsx("h3",{className:"text-lg font-medium text-gray-900 mb-2"},"No pods yet"),jsx("p",{className:"text-gray-500 mb-6"},"Spin up a pod or join one with a share code to get started."))))))
  )
}
...
export default function Component() {
  ...
  return (
    jsx(Fragment,{},jsx("div",{className:"flex w-full min-h-screen bg-gray-50"},jsx("div",{},jsx(Div_c1f3c749b807c06ffcf591c756121421,{},),jsx(Aside_06c0acd7e6bdf09e1f3254efc9bcd432,{},)),jsx(Aside_1ef380eabec6f8bf6ae3f4d1a32f6e09,{},),jsx("div",{className:"flex-1 flex flex-col min-w-0"},jsx("header",{className:"md:hidden flex items-center px-4 h-16 bg-white border-b border-gray-200 sticky top-0 z-30"},jsx(Button_0d8d7a023769a6649a4c5923bdbd66e6,{},),jsx(ReactRouterLink,{className:"text-lg font-bold text-indigo-600 hover:opacity-80 transition-opacity",to:"/landing"},"Meshflow")),jsx("main",{className:"flex-1 bg-gray-50 min-h-[calc(100vh-4rem)] md:min-h-screen overflow-auto transition-all duration-300"},jsx("div",{className:"p-8"},jsx("div",{className:"flex justify-between items-center mb-8"},jsx("h1",{className:"text-2xl font-bold text-gray-900"},"My Enablement Pods"),jsx("div",{className:"flex gap-3"},jsx(ReactRouterLink,{className:"bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-50 font-medium transition-colors",to:"/classes/create"},"+ Create Pod"),jsx(ReactRouterLink,{className:"bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 font-medium transition-colors shadow-sm",to:"/classes/join"},"Join Pod"))),jsx(Fragment_22a41101ff4841fb23790892a7cfad56,{},)))),jsx(Button_5c3b3b0b916bef960265a28869919bde,{},)),jsx("title",{},"App | Dashboard"),jsx("meta",{content:"favicon.ico",property:"og:image"},))
  )
}
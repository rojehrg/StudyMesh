...
function Input_4350876475374f27b6ce71c50a3658aa () {
...
const on_change_499cc3e6037f21f55a95869bf949bed3 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___class_state____class_state.set_new_class_name", ({ ["value"] : _e?.["target"]?.["value"] }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("input",{className:"w-full px-4 py-2 border border-gray-300 rounded-lg placeholder:text-gray-500 focus:border-[#4F46E5] focus:ring-1 focus:ring-[#4F46E5] outline-none focus:placeholder-transparent text-left caret-[#111827]",defaultValue:reflex___state____state__app___states___class_state____class_state.new_class_name_rx_state_,onChange:on_change_499cc3e6037f21f55a95869bf949bed3,placeholder:"e.g. Customer Insights Guild"},)
  )
}


function Input_ccbc7466e35f94cbedfb1751e6bd72a5 () {
  const reflex___state____state__app___states___class_state____class_state = useContext(StateContexts.reflex___state____state__app___states___class_state____class_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_change_205dd59fedb36eac07ed53533e3392b4 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___class_state____class_state.set_new_class_school", ({ ["value"] : _e?.["target"]?.["value"] }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("input",{className:"w-full px-4 py-2 border border-gray-300 rounded-lg placeholder:text-gray-500 focus:border-[#4F46E5] focus:ring-1 focus:ring-[#4F46E5] outline-none focus:placeholder-transparent text-left caret-[#111827]",defaultValue:reflex___state____state__app___states___class_state____class_state.new_class_school_rx_state_,onChange:on_change_205dd59fedb36eac07ed53533e3392b4,placeholder:"e.g. GTM Operations"},)
  )
}


function Input_5c4a696e94c8dfd6dedb8002357c17f0 () {
  const reflex___state____state__app___states___class_state____class_state = useContext(StateContexts.reflex___state____state__app___states___class_state____class_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_change_5c041e5462fe1eb7e3021530a9213717 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___class_state____class_state.set_new_class_professor", ({ ["value"] : _e?.["target"]?.["value"] }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("input",{className:"w-full px-4 py-2 border border-gray-300 rounded-lg placeholder:text-gray-500 focus:border-[#4F46E5] focus:ring-1 focus:ring-[#4F46E5] outline-none focus:placeholder-transparent text-left caret-[#111827]",defaultValue:reflex___state____state__app___states___class_state____class_state.new_class_professor_rx_state_,onChange:on_change_5c041e5462fe1eb7e3021530a9213717,placeholder:"e.g. Priya Shah"},)
  )
}


function Input_72807314fba02b1ceb672e642c85078c () {
  const reflex___state____state__app___states___class_state____class_state = useContext(StateContexts.reflex___state____state__app___states___class_state____class_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_change_8a996a32df5b1aec97d49ba7779d4631 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___class_state____class_state.set_new_class_term", ({ ["value"] : _e?.["target"]?.["value"] }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("input",{className:"w-full px-4 py-2 border border-gray-300 rounded-lg placeholder:text-gray-500 focus:border-[#4F46E5] focus:ring-1 focus:ring-[#4F46E5] outline-none focus:placeholder-transparent text-left caret-[#111827]",defaultValue:reflex___state____state__app___states___class_state____class_state.new_class_term_rx_state_,onChange:on_change_8a996a32df5b1aec97d49ba7779d4631,placeholder:"e.g. Q3 FY25"},)
  )
}


function Button_210f0fd6902c724759764ab6b7ad7dee () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_click_1d16d5748133c766895ca5eb66e5f74d = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___class_state____class_state.create_class", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("button",{className:"w-full bg-indigo-600 text-white py-3 rounded-xl font-bold hover:bg-indigo-700 transition-colors shadow-md",onClick:on_click_1d16d5748133c766895ca5eb66e5f74d},"Create Pod")
  )
}
...
export default function Component() {
  ...
  return (
    jsx(Fragment,{},jsx("div",{className:"flex w-full min-h-screen bg-gray-50"},jsx("div",{},jsx(Div_c1f3c749b807c06ffcf591c756121421,{},),jsx(Aside_06c0acd7e6bdf09e1f3254efc9bcd432,{},)),jsx(Aside_1ef380eabec6f8bf6ae3f4d1a32f6e09,{},),jsx("div",{className:"flex-1 flex flex-col min-w-0"},jsx("header",{className:"md:hidden flex items-center px-4 h-16 bg-white border-b border-gray-200 sticky top-0 z-30"},jsx(Button_0d8d7a023769a6649a4c5923bdbd66e6,{},),jsx(ReactRouterLink,{className:"text-lg font-bold text-indigo-600 hover:opacity-80 transition-opacity",to:"/landing"},"Meshflow")),jsx("main",{className:"flex-1 bg-gray-50 min-h-[calc(100vh-4rem)] md:min-h-screen overflow-auto transition-all duration-300"},jsx("div",{className:"p-8 flex items-center justify-center min-h-[80vh]"},jsx("div",{},jsx("h2",{className:"text-2xl font-bold text-gray-900 mb-6"},"Create a New Pod"),jsx("div",{className:"bg-white p-8 rounded-xl border border-gray-200 shadow-sm max-w-lg mx-auto"},jsx("div",{className:"mb-4"},jsx("label",{className:"block text-sm font-medium text-gray-700 mb-1"},"Pod Name"),jsx(Input_4350876475374f27b6ce71c50a3658aa,{},)),jsx("div",{className:"mb-4"},jsx("label",{className:"block text-sm font-medium text-gray-700 mb-1"},"Business Unit / Team"),jsx(Input_ccbc7466e35f94cbedfb1751e6bd72a5,{},)),jsx("div",{className:"flex gap-4 mb-6"},jsx("div",{className:"flex-1"},jsx("label",{className:"block text-sm font-medium text-gray-700 mb-1"},"Initiative Owner"),jsx(Input_5c4a696e94c8dfd6dedb8002357c17f0,{},)),jsx("div",{className:"w-40"},jsx("label",{className:"block text-sm font-medium text-gray-700 mb-1"},"Quarter / Timeline"),jsx(Input_72807314fba02b1ceb672e642c85078c,{},))),jsx(Button_210f0fd6902c724759764ab6b7ad7dee,{},)))))),jsx(Button_5c3b3b0b916bef960265a28869919bde,{},)),jsx("title",{},"App | Create"),jsx("meta",{content:"favicon.ico",property:"og:image"},))
  )
}
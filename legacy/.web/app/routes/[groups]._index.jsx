...
function Div_047260c954b1e3e4e2c7b5e049026ea4 () {
  ...
  return (
    jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"},Array.prototype.map.call(reflex___state____state__app___states___micro_group_state____micro_group_state.user_groups_rx_state_ ?? [],((group_rx_state_,index_87ec4798ce6e30ff5453377b6be3bde1)=>(jsx(ReactRouterLink,{className:"block",key:index_87ec4798ce6e30ff5453377b6be3bde1,to:("/groups/"+group_rx_state_?.["id"])},jsx("div",{className:"bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow h-full flex flex-col"},jsx("div",{className:"flex justify-between items-start mb-2"},jsx("h3",{className:"text-lg font-bold text-gray-900"},group_rx_state_?.["name"]),jsx("span",{className:"text-xs font-mono bg-green-100 text-green-700 px-2 py-1 rounded-md"},"Active")),jsx("p",{className:"text-sm font-mono text-gray-500 mb-4 bg-gray-50 p-1 rounded w-fit"},("Circle code: "+group_rx_state_?.["group_code"])),jsx("div",{className:"mt-auto pt-4 border-t border-gray-100"},jsx("span",{className:"text-sm font-semibold text-indigo-600 hover:text-indigo-800"},"View Circle \u2192"))))))))
  )
}


function Fragment_6bb7e5abb932b78f57ce60e0e38083a4 () {
  const reflex___state____state__app___states___micro_group_state____micro_group_state = useContext(StateContexts.reflex___state____state__app___states___micro_group_state____micro_group_state)



  return (
    jsx(Fragment,{},(isTrue(reflex___state____state__app___states___micro_group_state____micro_group_state.user_groups_rx_state_)?(jsx(Fragment,{},jsx(Div_047260c954b1e3e4e2c7b5e049026ea4,{},))):(jsx(Fragment,{},jsx("div",{className:"flex flex-col items-center justify-center py-20 bg-white rounded-xl border border-dashed border-gray-300"},jsx(LucideUsers,{className:"w-16 h-16 text-gray-300 mb-4"},),jsx("h3",{className:"text-lg font-medium text-gray-900 mb-2"},"No circles yet"),jsx("p",{className:"text-gray-500 mb-6"},"Spin up a circle from your pod dashboard or join with a code."))))))
  )
}

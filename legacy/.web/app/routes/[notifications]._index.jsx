...
import {Bell as LucideBell,BellOff as LucideBellOff,BookOpen as LucideBookOpen,Check as LucideCheck,ChevronLeft as LucideChevronLeft,CirclePlus as LucideCirclePlus,Info as LucideInfo,LayoutDashboard as LucideLayoutDashboard,LogIn as LucideLogIn,LogOut as LucideLogOut,Menu as LucideMenu,Settings as LucideSettings,Users as LucideUsers} from "lucide-react"
...
function Button_61d1757e5b34ea47bae9c6893a14a88f () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);

const on_click_70bffb59461d481fe25af2d19d761660 = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___notification_state____notification_state.mark_all_read", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx("button",{className:"text-sm text-indigo-600 hover:text-indigo-800 font-medium",onClick:on_click_70bffb59461d481fe25af2d19d761660},"Mark all as read")
  )
}


function Fragment_5ea524b5a5bdc1180b5650965da30544 () {
  const reflex___state____state__app___states___notification_state____notification_state = useContext(StateContexts.reflex___state____state__app___states___notification_state____notification_state)



  return (
    jsx(Fragment,{},((reflex___state____state__app___states___notification_state____notification_state.unread_count_rx_state_ > 0)?(jsx(Fragment,{},jsx(Button_61d1757e5b34ea47bae9c6893a14a88f,{},))):(jsx(Fragment,{},))))
  )
}


function Div_5895d03fa59b1ababe25f10a939754ae () {
  const reflex___state____state__app___states___notification_state____notification_state = useContext(StateContexts.reflex___state____state__app___states___notification_state____notification_state)
const [addEvents, connectErrors] = useContext(EventLoopContext);
  ...
  return (
    jsx("div",{className:"bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden"},Array.prototype.map.call(reflex___state____state__app___states___notification_state____notification_state.notifications_rx_state_ ?? [],((notification_rx_state_,index_b66896a7005cbbdb542c5daad8e4c721)=>(jsx("div",{className:(notification_rx_state_?.["read"] ? "bg-white border-b border-gray-100 hover:bg-gray-50 transition-colors" : "bg-indigo-50/30 border-b border-indigo-100 hover:bg-indigo-50/50 transition-colors"),key:index_b66896a7005cbbdb542c5daad8e4c721},jsx("div",{className:"flex items-start p-4"},jsx("div",{className:(notification_rx_state_?.["read"] ? "w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center" : "w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center")},jsx(LucideBell,{className:"w-5 h-5 text-indigo-600"},)),jsx("div",{className:"flex-1 ml-4"},jsx("p",{className:"text-sm font-medium text-gray-900"},notification_rx_state_?.["content"]),jsx("p",{className:"text-xs text-gray-500 mt-1"},("From "+notification_rx_state_?.["sender_name"]+" \u2022 "+notification_rx_state_?.["created_at"]))),jsx(Fragment,{},(!(notification_rx_state_?.["read"])?(jsx(Fragment,{},jsx("button",{className:"p-2 text-gray-400 hover:text-green-600 hover:bg-green-50 rounded-full transition-colors",onClick:((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___notification_state____notification_state.mark_as_read", ({ ["notification_id"] : notification_rx_state_?.["id"] }), ({  })))], [_e], ({  })))),title:"Mark as read"},jsx(LucideCheck,{className:"w-4 h-4"},)))):(jsx(Fragment,{},))))))))))
  )
}


function Fragment_e1824cc44a0f88868893fba0bad777d7 () {
  const reflex___state____state__app___states___notification_state____notification_state = useContext(StateContexts.reflex___state____state__app___states___notification_state____notification_state)



  return (
    jsx(Fragment,{},(isTrue(reflex___state____state__app___states___notification_state____notification_state.notifications_rx_state_)?(jsx(Fragment,{},jsx(Div_5895d03fa59b1ababe25f10a939754ae,{},))):(jsx(Fragment,{},jsx("div",{className:"flex flex-col items-center justify-center py-20 bg-white rounded-xl border border-dashed border-gray-300"},jsx(LucideBellOff,{className:"w-16 h-16 text-gray-300 mb-4"},),jsx("h3",{className:"text-lg font-medium text-gray-900 mb-2"},"All caught up"),jsx("p",{className:"text-gray-500"},"You have no new notifications."))))))
  )
}

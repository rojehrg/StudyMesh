...
def my_groups_page() -> rx.Component:
    return layout(
        rx.el.div(
            rx.el.div(
                rx.el.h1(
                    "Working Circles", class_name="text-2xl font-bold text-gray-900"
                ),
                rx.el.div(
                    rx.el.a(
                        "Join via Code",
            ...
            rx.cond(
                ...
                rx.el.div(
                    ...
                    rx.el.p(
                        "Spin up a circle from your pod dashboard or join with a code.",
    ...
    return layout(
        rx.el.div(
            rx.cond(
                ...
                rx.el.div(
                    rx.spinner(size="3"),
                    rx.el.p("Loading circle data...", class_name="mt-4 text-gray-500"),

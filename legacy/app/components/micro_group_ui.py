...
def group_card(group: dict) -> rx.Component:
    return rx.el.a(
        rx.el.div(
            ...
            rx.el.p(
                f"Circle code: {group.group_code}",
    ...
    return rx.el.div(
        ...
        rx.el.div(
            rx.el.div(
                ...
                rx.el.input(
                    placeholder="e.g. Platform Rollout SWAT",
            ...
            rx.el.div(
                ...
                rx.el.textarea(
                    placeholder="What business objective or enablement outcome is this circle driving?",
...
def invite_section() -> rx.Component:
    return rx.el.div(
        rx.el.h3("Invite collaborators", class_name="text-lg font-bold text-gray-900 mb-3"),
        rx.el.div(
            rx.el.div(
                rx.el.span(
                    "Circle Code",
            ...
            rx.el.div(
                rx.el.p(
                    "Share a kickoff note",
                    class_name="text-sm font-medium text-gray-700 mb-2",
                ),
                rx.el.div(
                    rx.foreach(
                        ["Quick Win", "Deep Dive", "Shadowing"],
                ...
                rx.el.div(
                    ...
                    rx.el.div(
                        ...
                        share_button(
                            ...
                            f"mailto:?subject=Join my Working Circle&body={MicroGroupState.generated_intro_message}",
                        ),
...
def member_list() -> rx.Component:
    return rx.el.div(
        rx.el.h3("Circle Members", class_name="text-lg font-bold text-gray-900 mb-3"),
        rx.el.div(
            rx.foreach(
...
def group_stats() -> rx.Component:
    return rx.el.div(
        rx.el.h3("Circle Insights", class_name="text-lg font-bold text-gray-900 mb-3"),
        rx.el.div(
            rx.el.div(
                rx.el.span(
                    "Avg Compatibility",
